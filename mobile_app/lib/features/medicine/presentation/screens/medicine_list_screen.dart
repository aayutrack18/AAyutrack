          ...
          : state.hasError
              ...
              : state.medicines.isEmpty
                  ? EmptyState(
                      ...
                      message:
                          'Build your medication routine here. Add your prescribed medicines so reminders, compliance, and reports can work together.',
    ...
    return ListView(
      ...
      children: [
        ...
        if (state.activeMedicines.isNotEmpty) ...[
          ...
          ...state.activeMedicines.map((m) => _MedicineCard(medicine: m)),
          const SizedBox(height: 8),
        ],
        if (state.inactiveMedicines.isNotEmpty) ...[
          const SectionHeader(title: 'Paused'),
          const SizedBox(height: 10),
          ...state.inactiveMedicines.map((m) => _MedicineCard(medicine: m)),
        ],
      ],
    );
  }
