    ...
    return ListView(
      ...
      children: [
        ...
        ...templates.map((t) {
          ...
          return Padding(
            ...
            child: GestureDetector(
              onTap: () =>
                  ref.read(reportsProvider.notifier).setTemplate(t.id),
        ...
        AppCard(
          child: Column(
            children:
                reportsState.sections.asMap().entries.map((entry) {
              final idx = entry.key;
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: const Row(children: [
                          ...
                          SizedBox(width: 10),
                          Expanded(
                              child: Text('PDF report generated successfully')),
                        ]),
            ...
            Expanded(
              child: Column(
                  ...
                  children: [
                    ...
                    const Text('Tap to preview or share',
                        style: TextStyle(
                            fontSize: 12, color: AppColors.textMuted)),
                  ]),
            ),
