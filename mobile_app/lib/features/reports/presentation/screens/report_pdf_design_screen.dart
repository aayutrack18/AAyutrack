...
class _ReportPdfDesignScreenState extends ConsumerState<ReportPdfDesignScreen> {
  ...
  Future<void> _shareWithDoctor(BuildContext context) async {
    _saveDesignField();
  ...
  Future<void> _shareSavedFile(
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Failed to share saved report: $e'),
          backgroundColor: AppColors.danger,
          behavior: SnackBarBehavior.floating,
        ),
      );
  ...
  Widget build(BuildContext context) {
    ...
    final selectedScheme = _colorSchemes.firstWhere(
      (c) => c.id == design.colorSchemeId,
            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, i) {
                ...
                return GestureDetector(
                  onTap: () => ref.read(reportsProvider.notifier).updatePdfDesign(
                ...
                Expanded(
                  child: AppButton(
                    ...
                    onPressed: () {
                      ...
                      _shareSavedFile(context, filePath);
                    },
                  ),
                ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            'Overall Compliance: ${compliance.overallScore.toInt()}% · Medicine Adherence: ${compliance.medicineAdherence.toInt()}%',
            style: TextStyle(
              fontSize: 11,
              fontWeight: FontWeight.w600,
              color: scheme.primary,
